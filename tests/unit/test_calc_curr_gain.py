    ...
    return pd.DataFrame(
        {
            ...
            "trans_val_asset": [-100, 130, 0, 0, 120, 0, -1000],
            "curr_val_asset": [1150, 1000, 1500, 1080, 1210, 1200, 1100],
            "curr_abs_gain_asset": [900.0, 850.0, 620.0, 200.0, 330.0, 200.0, 0.0],
            "curr_perc_gain_asset": [81.82, 85.0, 62.0, 20.0, 33.0, 20.0, 0.0],
            "money_out": [-1100.0, -1000.0, -1000.0, -1000.0, -1000.0, -1000.0, -1000.0],
            "money_in": [2000.0, 1850.0, 1620.0, 1200.0, 1330.0, 1200.0, 1100.0],
        },
    ).assign(date=lambda df: pd.to_datetime(df["date"], format="%Y-%m-%d"))
    ...
    return pd.DataFrame(
        {
            ...
            "trans_val_asset": [-100, 130, 0, 0, 120, 0, -1000, 0],
            "curr_val_asset": [1150, 1000, 1500, 1080, 1210, 1200, 1100, 0],
            "curr_abs_gain_asset": [900.0, 850.0, 620.0, 200.0, 330.0, 200.0, 100, 0],
            "curr_perc_gain_asset": [81.82, 85.0, 62.0, 20.0, 33.0, 20.0, 10.0, 0],
            "money_out": [-1100.0, -1000.0, -1000.0, -1000.0, -1000.0, -1000.0, -1000.0, 0.0],
            "money_in": [2000.0, 1850.0, 1620.0, 1200.0, 1330.0, 1200.0, 1100.0, 0.0],
        },
    ).assign(date=lambda df: pd.to_datetime(df["date"], format="%Y-%m-%d"))
    ...
    return pd.DataFrame(
        {
            ...
            "trans_val_asset": [700, 100, 0, 0, 1250, 0, -1000, 0],
            "curr_val_asset": [0, 700, 0, 0, 0, 1200, 1100, 0],
            "curr_abs_gain_asset": [450.0, 450.0, 250.0, 250.0, 250.0, 200.0, 100, 0],
            "curr_perc_gain_asset": [28.12, 28.12, 25.0, 25.0, 25.0, 20.0, 10.0, 0],
            "money_out": [-1600.0, -1600.0, -1000.0, -1000.0, -1000.0, -1000.0, -1000.0, 0.0],
            "money_in": [2050.0, 2050.0, 1250.0, 1250.0, 1250.0, 1200.0, 1100.0, 0.0],
        },
    ).assign(date=lambda df: pd.to_datetime(df["date"], format="%Y-%m-%d"))
